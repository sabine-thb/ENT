...
<body>
    ...
    <section class="section1" id="contenu">
        ...
        <img src="./style/img/actus/actu3.jpg" alt="Image Actualité" srcset="" class="actuPrincipale">
    ...
    <section class="section2">
        ...
        <div class="actus">
            <div class="actuContainer">
                <a href="actus.php" aria-label="Lien vers la page de l'actualité 1"><img src="./style/img/actus/actu1.jpg" alt="Image Actualité 1" srcset="" class=" actu actu2"></a>
            ...
            <div class="actuContainer">
                <a href="actu2.php" aria-label="Lien vers la page de l'actualité 2"><img src="./style/img/actus/actu2.jpg" alt="Image Actualité 2" srcset="" class=" actu actu3"></a>
            ...
            <div class="actuContainer">
                <a href="actu4.php" aria-label="Lien vers la page de l'actualité 4"><img src="./style/img/actus/actu4.jpg" alt="Image Actualité 4" srcset="" class="actu actu4"></a>
                <h2>Plastic Odyssey : un tour du monde engagé dans la lutte contre la pollution plastique</h2>
                <p class="descr">Focus sur le projet Recityplast porté par l’Université Gustave Eiffel, présenté à l’occasion de la première escale de l’expédition à Dakar, au Sénégal.</p>
            </div>
        </div>
