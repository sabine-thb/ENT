    ...
    <section class="section2">
        ...
        <div class="actus">
            <div class="actuContainer">
                <a href="actu2.php" aria-label="Lien vers la page de l'actualité 2"><img src="./style/img/actus/actu2.jpg" alt="Image Actualité 2" srcset="" class=" actu actu2"></a>
            ...
            <div class="actuContainer">
                <a href="actu3.php" aria-label="Lien vers la page de l'actualité 3"><img src="./style/img/actus/actu3.jpg" alt="Image Actualité 3" srcset="" class=" actu actu3"></a>
